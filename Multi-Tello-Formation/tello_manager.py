...
class Tello:
    ...
    def send_command(self, command, quite=False):
        return self.Tello_Manager.send_command(command, self.tello_ip, quite)
...
class Tello_Manager:
    ...
    def send_command(self, command, ip, quite=False):
        """
