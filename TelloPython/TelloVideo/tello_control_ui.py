...
class TelloUI:
    ...
    def __init__(self, tello, outputpath):
        ...
        Raises:
            RuntimeError: If the Tello rejects the attempt to enter
            command mode.
        """
        # videostream device
        self.tello = tello
        # the path that save pictures created by clicking the takeSnapshot btn
        ...
        """ if the flag is TRUE,the auto-takeoff thread will stop waiting for the
            response from tello """
        ...
        self.btn_snapshot.pack(side="bottom", fill="both", expand="yes",
                               padx=10, pady=5)

        self.btn_pause = tki.Button(self.root, text="Pause",
                                    relief="raised", command=self.pauseVideo)
        self.btn_pause.pack(side="bottom", fill="both", expand="yes", padx=10,
                            pady=5)

        self.btn_landing = tki.Button(
            self.root, text="Open Command Panel", relief="raised",
    ...
    def videoLoop(self):
        ...
        Raises:
            RuntimeError: To get around a RunTime error that Tkinter throws due
            to threading.
        """
        try:
    ...
    def openCmdWindow(self):
        ...
        self.btn_distance = tki.Button(panel, text="Reset Degree",
                                       relief="raised", command=self.updateDegreebar)
