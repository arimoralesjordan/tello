...
class Tello:
    ...
    def __init__(
        ...
        self.local_video_port = 8888  # port for receiving video stream
        self.last_height = 0
    ...
    def get_udp_video_address(self):
        ...
        return 'udp://@' + self.local_ip + ':' + str(self.local_video_port)
    ...
    def _receive_video_thread(self):
        ...
        """
        packet_data = ""
        print("Entro receive_video_thread")
        while True:
            try:
                ...
                # end of frame
                print("Image socket.Data : %s" % packet_data)   
                ...
                print("Caught exception Image socket.error : %s" % exc)
